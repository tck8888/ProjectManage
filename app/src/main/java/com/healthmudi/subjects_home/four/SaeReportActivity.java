...
public class SaeReportActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        mTvSubjectsPeople = (TextView) findViewById(R.id.tv_subjects_people);
    ...
    public void setListener() {
        ...
        findViewById(R.id.ll_subjects_people).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_subjects_people:
                ...
                mSelectSubjectDilaog.show(getSupportFragmentManager(), "SelectSubjectDilaog");
                break;
    ...
    private void submitData() {
        ...
        HttpRequest.getInstance().post(HttpUrlList.PROJECT_JOB_SAE_REP_URL, map, tag, new OnServerCallBack<HttpResult<Object>, Object>() {
            ...
            public void onSuccess(Object result) {
                LoadingDialog.getInstance(SaeReportActivity.this).hidden();
                mIosDialog.show();
            }
            ...
            public void onFailure(int code, String mesage) {
                ...
                if (!TextUtils.isEmpty(mesage)) {
                    Toast.makeText(SaeReportActivity.this, mesage, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private boolean checkData(String operation_date, String job_time) {
        ...
        if (TextUtils.isEmpty(subjects_id)) {
            Toast.makeText(this, "请选择受试者", Toast.LENGTH_SHORT).show();
            return true;
        }
        if (TextUtils.isEmpty(operation_date)) {
            Toast.makeText(this, "请选择SAE上报日期", Toast.LENGTH_SHORT).show();
            return true;
        }
