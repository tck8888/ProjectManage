...
public class VisitorsVisitToTheRulesActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String tag = "VisitorsVisitToTheRulesActivity";
    ...
    private void submitData() {
        ...
        HttpRequest.getInstance().post(HttpUrlList.PROJECT_JOB_SUBJECT_VISIT_URL, map, tag, new OnServerCallBack<HttpResult<Object>, Object>() {
            @Override
            public void onSuccess(Object result) {
                LoadingDialog.getInstance(VisitorsVisitToTheRulesActivity.this).hidden();
                mIosDialog.show();
            }
            ...
            public void onFailure(int code, String mesage) {
                ...
                if (!TextUtils.isEmpty(mesage)) {
                    Toast.makeText(VisitorsVisitToTheRulesActivity.this, mesage, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
