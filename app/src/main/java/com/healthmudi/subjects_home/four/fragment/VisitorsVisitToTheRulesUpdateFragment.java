...
public class VisitorsVisitToTheRulesUpdateFragment extends BaseFragment1 implements View.OnClickListener {
    ...
    public void submitData() {
        ...
        HttpRequest.getInstance().post(ProjectManageHttpUrlList.PROJECT_JOB_SUBJECT_VISIT_URL, map, tag, new OnServerCallBack<HttpResult<Object>, Object>() {
            @Override
