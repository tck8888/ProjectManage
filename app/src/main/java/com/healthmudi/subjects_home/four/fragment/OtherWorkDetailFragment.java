...
public class OtherWorkDetailFragment extends BaseFragment1 {
    ...
    public static OtherWorkDetailFragment newInstance(WorkingHoursListBean workingHoursListBean){
        OtherWorkDetailFragment contractFollowUpDetailFragment = new OtherWorkDetailFragment();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_other_work_detail;
    }
