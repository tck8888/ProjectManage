...
public class ProjectStartMeetingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String tag = "ProjectStartMeetingActivity";
    ...
    public void initView() {
        ...
        mTvKickOffDate = (TextView) findViewById(R.id.tv_kick_off_date);
    ...
    public void setListener() {
        ...
        findViewById(R.id.ll_kick_off_date).setOnClickListener(this);
    ...
    private void submitData() {
        ...
        HttpRequest.getInstance().post(HttpUrlList.PROJECT_JOB_KICK_OFF_URL, map, tag, new OnServerCallBack<HttpResult<Object>, Object>() {
            ...
            public void onSuccess(Object result) {
                LoadingDialog.getInstance(ProjectStartMeetingActivity.this).hidden();
                mIosDialog.show();
            }
            ...
            public void onFailure(int code, String mesage) {
                ...
                if (!TextUtils.isEmpty(mesage)) {
                    Toast.makeText(ProjectStartMeetingActivity.this, mesage, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void checkData(String kick_off_date, String job_time) {
        ...
        if (TextUtils.isEmpty(kick_off_date)) {
            Toast.makeText(this, "请选择启动会日期", Toast.LENGTH_SHORT).show();
            return;
        }
