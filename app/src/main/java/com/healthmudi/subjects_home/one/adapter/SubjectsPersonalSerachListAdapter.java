...
public class SubjectsPersonalSerachListAdapter extends BaseExpandableListAdapter {

    private Context mContext;
    private List<SubjectsListBean> mDataList;
    private LayoutInflater mInflater;

    public SubjectsPersonalSerachListAdapter(Context context, List<SubjectsListBean> subjectsListBeanList) {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        convertView = mInflater.inflate(R.layout.subjects_child_item1, parent, false);
