...
public class InformationMoreListAdapter extends BaseExpandableListAdapter {

    private Context mContext;
    private List<SubjectsListBean> mDataList;
    private LayoutInflater mInflater;

    public InformationMoreListAdapter(Context context, List<SubjectsListBean> subjectsListBeanList) {
